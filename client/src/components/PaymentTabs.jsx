    ...
    <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', padding: '5px', boxShadow: '0px 0px 5px 0px rgba(0,0,0,0.75)',
      ...
      <Box sx={{ borderBottom: 1, borderColor: 'divider', display: 'flex', justifyContent: 'center'  }}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example"  variant="scrollable" scrollButtons allowScrollButtonsMobile>
          ...
          {/*<Tab style={{fontFamily: 'inherit'}} label="DEBITO/CREDITO" {...a11yProps(2)} />*/}
          {/*<Tab style={{fontFamily: 'inherit'}} label={<Logo src='https://www.paypalobjects.com/digitalassets/c/website/marketing/apac/C2/logos-buttons/optimize/Online_Primary_Acceptance_Mark_RGB_V2_small.jpg' alt='Paypal' />} {...a11yProps(3)} />*/}
        </Tabs>
      </Box>
      ...
      {/*<TabPanel style={{display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '10px'}} value={value} index={3}>

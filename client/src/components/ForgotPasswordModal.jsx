...
export default function ForgotPasswordModal({title, iconColor}) {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      setErrorMsg({...errorMsg, email: 'El mail que seleccionó no se encuentra registado. Cree una nueva cuenta!'})
    }
  ...
  return (
    <Container>
      <Button style={{fontSize: '14px', padding: '0px', margin: '0px', color: '000', textDecoration: 'none'}} onClick={handleOpen}><u>No recuerdas la contraseña?</u></Button>
      <Modal
        open={open}
        onClose={handleClose}

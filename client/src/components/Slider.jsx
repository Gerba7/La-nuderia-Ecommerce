...
import Cover1 from '../images/la_nuderia_tapices_portada2.jpg';
...
const Slider = () => {
    ...
    const items = [
        ...
        },
        {
            id: 3,
            description: "Diseños en macramé",
            img: 'https://firebasestorage.googleapis.com/v0/b/la-nuderia.appspot.com/o/Slider3.jpg?alt=media&token=ccd01d80-b0ac-42a0-9107-20b49be7c3e9', //'https://firebasestorage.googleapis.com/v0/b/la-nuderia.appspot.com/o/Tapices.jpg?alt=media&token=515273f1-1ae8-4185-af89-4237b82aeb7e',
            title: 'CORTINAS',
            button: 'COMPRAR AHORA',

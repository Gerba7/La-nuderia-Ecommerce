...
import LoginModalCart from './LoginModalCart';
...
export default function RegisterModalCart({title}) {
  ...
  const handleRegister = async (dispatch, user) => {
    ...
    if(errorCheck()) return console.log('Hay errores')
      ...
      >
        ...
        <Box sx={style2}>
          ...
          <Typography id="modal-modal-title" variant="h6" component="h2" sx={{marginBottom: '30px'}}> 
            ...
            INICIA SESIÓN 
            <LoginCircle>
              <LoginModalCart iconColor={'#216E8C'}/>
            </LoginCircle>
